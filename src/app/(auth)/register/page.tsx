  ...
  return (
    <div className="mx-auto w-full max-w-sm space-y-6">
      <div className="space-y-2 text-center">
        ...
        <h1 className="text-3xl font-semibold text-white font-[family-name:var(--font-display)]">
          Create your account
        </h1>
        <p className="text-neutral-400">
          Start tracking your portfolio in a few seconds.
        </p>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs text-neutral-500">or sign up with email</span>
        <div className="h-px flex-1 bg-neutral-800" />
      </div>
